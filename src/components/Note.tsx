    ...
    <>
      <div className="mb-3 flex flex-wrap items-start justify-between gap-1">
        ...
        <div>
          <button
            onClick={() => navigate("/")}
            className="hidden items-center gap-1 rounded-full bg-slate-400 py-1.5 px-4 text-sm font-semibold leading-none text-white outline-2 outline-purple-300 transition-colors duration-300 hover:bg-slate-500 focus:bg-slate-500 focus:outline active:bg-slate-600 dark:bg-slate-500 dark:hover:bg-slate-600 dark:active:bg-slate-700 sm:flex"
          >
            <svg
          ...
          <button
            onClick={() => navigate("/")}
            className="flex items-center gap-1 rounded-full bg-slate-400 py-1.5 px-2.5 text-sm font-semibold leading-none text-white outline-2 outline-purple-300 transition-colors duration-300 hover:bg-slate-500 focus:bg-slate-500 focus:outline active:bg-slate-600 sm:hidden"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          className="rounded-full bg-red-400 py-2 px-5 text-sm font-semibold leading-none text-white outline-2 outline-purple-300 transition-colors duration-300 hover:bg-red-500 focus:bg-red-500 focus:outline active:bg-red-600 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:bg-red-600 dark:active:bg-red-700"
          onClick={() => {
            onDelete(note.id);
            navigate("/");
          }}
